...
import TipsyRum from '../Json_data/Rum'
import { Navigate, useNavigate } from 'react-router-dom'
export default function Rum({AddToCart2}) {
          ...
          TipsyRum.map((data)=>(
            <div className="col-sm-4 text-center my-3">
              <div className="card p-3 myCard text-light">
                <img src={data.Product_image[0].mainImg} alt="" className='card-img-top' height="400px" />
                <div className="card-body">
                  ...
                  <button className='btn btn-warning' onClick={()=>AddToCart2(data)}>Add to cart</button>
